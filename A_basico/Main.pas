...
begin
  ...
  case iTempoRestante of
    ...
    Self.Label5.Caption := Format('FALTAM %d SEGUNDOS PARA A CHAVE SUMIR',
      [iTempoRestante]);
...
begin
  ...
  Self.FConn.&SET('CODERAGE:DEF123#', 'OLÁ MUNDO');
  Self.FConn.&SET('CODERAGE:GHI123#', 'OLÁ MUNDO');
  Self.FConn.&SET('CODERAGE:JKL123#', 'OLÁ MUNDO');
  Self.FConn.&SET('CODERAGE:ABC456#', 'OLÁ MUNDO');
